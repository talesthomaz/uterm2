    ...
    def update_angle(self):
        ...
        if position == Gtk.PositionType.LEFT:
            if hasattr(self, 'set_orientation'):
                self.set_orientation(Gtk.Orientation.VERTICAL) # change to horizontal
            self.label.set_angle(0) # change to 0 degres for horizontal label
            self.set_size_request(120,0) # set tab size here <w,h>
